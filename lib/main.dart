      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          primaryColor: const Color(
              0xFF00E5FF), // Neon Cyan (keeping original primaryColor as it's not explicitly removed/changed in the theme block)
          colorScheme: const ColorScheme.dark(
            primary: Color(
                0xFF00E5FF), // Neon Cyan (keeping original primary as it's not explicitly removed/changed in the theme block)
            secondary: Color(
                0xFFFF4081), // Neon Pink (keeping original secondary as it's not explicitly removed/changed in the theme block)
            surface: Color(
                0xFF12121A), // Keeping original surface as it's not explicitly removed/changed in the theme block
