  ...
  Future<void> _shareStats() async {
    try {
      ...
      await Share.shareXFiles([XFile(file.path)],
          text: 'My ChronoDash Mission Log 🚀');
    } catch (e) {
                ...
                children: [
                  ...
                  TableCalendar(
                    ...
                    calendarStyle: CalendarStyle(
                      ...
                      weekendTextStyle:
                          GoogleFonts.rajdhani(color: Colors.white70),
                      outsideTextStyle:
                          GoogleFonts.rajdhani(color: Colors.grey),
                      todayTextStyle: GoogleFonts.orbitron(
      ...
      children: [
        ...
        Text(label,
            style: GoogleFonts.rajdhani(
                fontSize: 12, color: Colors.grey, letterSpacing: 1.5)),
      ],
    );
  }
}
