        ...
        builder: (context, provider, child) {
          return ReorderableListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                key: ValueKey('${step.speedLabel}_${step.durationSeconds}_$index'), // Unique key
                ...
                child: ListTile(
                  key: ValueKey('${step.speedLabel}_${step.durationSeconds}_$index'),
                  ...
                  trailing: Row(
                    ...
                    children: [
                        IconButton(
                            ...
                            onPressed: () => _showEditDialog(context, provider, index, step),
                        ),
